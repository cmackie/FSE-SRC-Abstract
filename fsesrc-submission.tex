...
represent the sign (positive or negative) of a value.  An unsigned integer uses all
bits of the machine representation to represent a value.
An unsigned integer can represent a larger range of positive numbers than a signed integer, but
...
operations, a programmer must run a different implementation of the operator depending on whether
...
jake2 consists of 133513 lines of code and can be found at \url{https://github.com/mbien/jake2}.
We wrote 33 \<@Unsigned> annotations, referring to the
...
\begin{thebibliography}{9}
  ...
  \bibitem{JDK8UnsignedIntegerArithmetic2012}
  Joseph Darcy. Unsigned Integer Arithmetic API now in JDK 8. \url{https://blogs.oracle.com/darcy/entry/unsigned_api}, Jan. 20, 2012.

  \bibitem{Ernst2008}
  Matthew M. Papi, Mahmood Ali, Telmo Luis Correa Jr., Jeff H. Perkins, and
  Michael D. Ernst. Practical Pluggable Types for Java. In ISSTA, July 2008.

  \bibitem{DietlDEMS2011}
  Werner Dietl, Stephanie Dietzel, Michael D. Ernst, Kıvanç Muslu, and Todd W. Schiller.
  Building and Using Pluggable Type Checkers. In ICSE, May 2011.

  \bibitem{JSR308-PFD}
  Michael D. Ernst. Type Annotations Specification (JSR 308). \url{https://types.cs.washington.edu/jsr308/specification/java-annotation-design.pdf},
  May 2, 2013.
