...
produces incorrect results when run on two unsigned values. To compute the
corresponding mathematical operation for a sensitive operator on unsigned values,
a library call must be made.  For such
